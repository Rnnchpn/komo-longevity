# KŌMØ English-first site map

## Primary English routes

| Route | Role | Main conversion |
|---|---|---|
| `/` | Brand, method and access points | Explore mobility / understand the ecosystem |
...
- The KŌMØ Locomo Check is educational and does not diagnose.
