/* KŌMØ Pulse — final patient route activation runtime v1
...
(() => {
  ...
  function mounted(r){
    ...
    if(r==='documents')return !!document.querySelector('[data-kbook-patient]');
    return true;
  }
  ...
  function invoke(r){
    ...
    try{
      ...
      else if(r==='documents')window.KomoBooking?.refreshPatient?.();
