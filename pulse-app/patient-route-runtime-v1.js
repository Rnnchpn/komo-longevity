/* KŌMØ Pulse — final patient route activation runtime v1.3
...
(() => {
  ...
  function mounted(r){
    ...
    if(r==='documents')return !!document.querySelector('[data-agenda-hub-v5]');
    return true;
  }
  ...
  function invoke(r){
    ...
    try{
      ...
      else if(r==='documents')window.KomoAgendaHubV5?.refresh?.();
