...
import { downloadMobilityReport } from './mobility-report-pdf-v3.js?v=20260903-motion-sensor-v5';
import { loadReportSnapshot } from './report-runtime-v1.js';

const VERSION='4.0.0-sensor';
let busy=false;
...
window.KomoCanonicalReport={version:VERSION,owner:'motion-report-sensor-v5',schema:SCHEMA_VERSION,export:exportCanonicalMobilityReport};
