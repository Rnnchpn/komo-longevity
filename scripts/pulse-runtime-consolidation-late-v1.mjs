...
console.log('[pulse-runtime-late] zero whole-body observers retained; Motion shared Supabase; four low-risk route writers centralized; patient-route-runtime-v2 retired');
