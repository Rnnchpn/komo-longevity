...
const assetVersion = '20260831-pro-v1';
...
const copies = {
  en: {
    ...
    heroTitle: 'Bring locomotor longevity<br><em>into your setting.</em>',
    ...
    proof: ['KŌMØ Case · six sensors · Pulse · protocol', 'Purchase · founding pilot · operated sessions · multi-site', 'Professional enquiry only · no patient health data'],
    introEyebrow: 'START A PROFESSIONAL CONVERSATION',
    introTitle: 'Tell us about<br><em>your project.</em>',
    introLead: 'A few operational details help us understand the setting, expected volume and level of support you need. We use this information only to review your professional enquiry.',
    aside: [
    ...
    formTitle: 'Professional enquiry',
    formLead: 'Fields marked * are required.',
    time: '≈ 4 min',
    sections: ['Your contact', 'Your organisation', 'Your KŌMØ project', 'Project details'],
    fields: {
    ...
    organisationTypes: [['', 'Select'], ['medical', 'Medical / longevity centre'], ['physician', 'Physician / private practice'], ['fitness', 'Fitness / performance club'], ['hospitality', 'Hotel / spa / resort / retreat'], ['corporate', 'Company / insurer / mutual'], ['sport', 'Sports organisation / team'], ['concierge', 'Private concierge / villa / yacht'], ['distributor', 'Distributor / network'], ['other', 'Other']],
    sites: [['', 'Select'], ['1', '1 site'], ['2-5', '2–5 sites'], ['6-20', '6–20 sites'], ['20+', 'More than 20 sites'], ['na', 'Not applicable yet']],
    assessments: [['', 'Select'], ['<10', 'Fewer than 10 / month'], ['10-30', '10–30 / month'], ['31-100', '31–100 / month'], ['100+', 'More than 100 / month'], ['unknown', 'To be defined']],
    timeline: [['', 'Select'], ['now', 'Immediately / < 1 month'], ['1-3', '1–3 months'], ['3-6', '3–6 months'], ['6-12', '6–12 months'], ['explore', 'Exploratory']],
    ...
    submit: 'Send my professional enquiry →',
  ...
  fr: {
    ...
    heroTitle: 'Déployez la longévité locomotrice<br><em>dans votre structure.</em>',
    ...
    proof: ['KŌMØ Case · six capteurs · Pulse · protocole', 'Achat · pilote fondateur · sessions opérées · multi-sites', 'Demande professionnelle uniquement · aucune donnée patient'],
    introEyebrow: 'OUVRIR UNE CONVERSATION PROFESSIONNELLE',
    introTitle: 'Parlez-nous de<br><em>votre projet.</em>',
    introLead: 'Quelques informations opérationnelles nous permettent de comprendre votre structure, le volume envisagé et le niveau d’accompagnement souhaité. Elles sont utilisées uniquement pour traiter votre demande professionnelle.',
    aside: [
    ...
    formLead: 'Les champs marqués * sont obligatoires.',
    time: '≈ 4 min',
    sections: ['Vos coordonnées', 'Votre structure', 'Votre projet KŌMØ', 'Détails du projet'],
    fields: {
    ...
    organisationTypes: [['', 'Sélectionner'], ['medical', 'Centre médical / longévité'], ['physician', 'Médecin / cabinet libéral'], ['fitness', 'Club fitness / performance'], ['hospitality', 'Hôtel / spa / resort / retreat'], ['corporate', 'Entreprise / mutuelle / assurance'], ['sport', 'Organisation / équipe sportive'], ['concierge', 'Conciergerie privée / villa / yacht'], ['distributor', 'Distributeur / réseau'], ['other', 'Autre']],
    sites: [['', 'Sélectionner'], ['1', '1 site'], ['2-5', '2–5 sites'], ['6-20', '6–20 sites'], ['20+', 'Plus de 20 sites'], ['na', 'Pas encore défini']],
    assessments: [['', 'Sélectionner'], ['<10', 'Moins de 10 / mois'], ['10-30', '10–30 / mois'], ['31-100', '31–100 / mois'], ['100+', 'Plus de 100 / mois'], ['unknown', 'À définir']],
    timeline: [['', 'Sélectionner'], ['now', 'Immédiatement / < 1 mois'], ['1-3', '1–3 mois'], ['3-6', '3–6 mois'], ['6-12', '6–12 mois'], ['explore', 'Phase exploratoire']],
    contact: [['email', 'E-mail'], ['phone', 'Téléphone'], ['whatsapp', 'WhatsApp'], ['video', 'Visioconférence']],
    interestsTitle: 'Je suis intéressé par',
    ...
    submit: 'Envoyer ma demande professionnelle →',
  ...
  es: {
    ...
    heroTitle: 'Lleva la longevidad locomotora<br><em>a tu organización.</em>',
    ...
    proof: ['KŌMØ Case · seis sensores · Pulse · protocolo', 'Compra · piloto fundador · sesiones operadas · multi-sede', 'Solicitud profesional · sin datos de pacientes'],
    introEyebrow: 'INICIAR UNA CONVERSACIÓN PROFESIONAL',
    introTitle: 'Cuéntanos<br><em>tu proyecto.</em>',
    introLead: 'Algunos datos operativos nos ayudan a comprender tu organización, el volumen previsto y el nivel de acompañamiento que necesitas. Se utilizan únicamente para gestionar tu solicitud profesional.',
    aside: [
    ...
    formLead: 'Los campos marcados * son obligatorios.',
    time: '≈ 4 min',
    sections: ['Tus datos', 'Tu organización', 'Tu proyecto KŌMØ', 'Detalles del proyecto'],
    fields: {
    ...
    organisationTypes: [['', 'Seleccionar'], ['medical', 'Centro médico / longevidad'], ['physician', 'Médico / consulta privada'], ['fitness', 'Club fitness / rendimiento'], ['hospitality', 'Hotel / spa / resort / retreat'], ['corporate', 'Empresa / aseguradora / mutua'], ['sport', 'Organización / equipo deportivo'], ['concierge', 'Concierge privado / villa / yacht'], ['distributor', 'Distribuidor / red'], ['other', 'Otro']],
    sites: [['', 'Seleccionar'], ['1', '1 sede'], ['2-5', '2–5 sedes'], ['6-20', '6–20 sedes'], ['20+', 'Más de 20 sedes'], ['na', 'Aún no definido']],
    assessments: [['', 'Seleccionar'], ['<10', 'Menos de 10 / mes'], ['10-30', '10–30 / mes'], ['31-100', '31–100 / mes'], ['100+', 'Más de 100 / mes'], ['unknown', 'Por definir']],
    timeline: [['', 'Seleccionar'], ['now', 'Inmediatamente / < 1 mes'], ['1-3', '1–3 meses'], ['3-6', '3–6 meses'], ['6-12', '6–12 meses'], ['explore', 'Fase exploratoria']],
    contact: [['email', 'E-mail'], ['phone', 'Teléfono'], ['whatsapp', 'WhatsApp'], ['video', 'Videollamada']],
    interestsTitle: 'Me interesa',
    ...
    submit: 'Enviar mi solicitud profesional →',
...
const optionList = (items) => items.map(([value, label]) => `<option value="${esc(value)}">${esc(label)}</option>`).join('');

function hero(c) {
  return `<section class="professional-hero"><div class="shell professional-hero-grid"><div><p class="eyebrow eyebrow-light">${esc(c.eyebrow)}</p><h1>${c.heroTitle}</h1><p class="professional-hero-lead">${esc(c.heroLead)}</p></div><ul class="professional-hero-proof" aria-label="KŌMØ professional deployment">${c.proof.map((item) => `<li>${esc(item)}</li>`).join('')}</ul></div></section>`;
}
...
function select(label, name, options, required = false) {
  return `<div class="professional-field"><label for="pro-${name}">${esc(label)}</label><select id="pro-${name}" name="${name}" ${required ? 'required' : ''}>${optionList(options)}</select></div>`;
}
...
function contactSection(locale, c) {
  ...
  return `<section class="professional-enquiry" id="contact-form"><div class="shell"><div class="professional-enquiry-intro reveal"><div><p class="eyebrow">${esc(c.introEyebrow)}</p><h2>${c.introTitle}</h2></div><p>${esc(c.introLead)}</p></div><div class="professional-enquiry-grid"><aside class="professional-enquiry-aside reveal">${c.aside.map(([title, body]) => `<div class="professional-enquiry-aside-card"><strong>${esc(title)}</strong><p>${esc(body)}</p></div>`).join('')}<a class="professional-enquiry-mail" href="mailto:contact@komolongevity.com"><span>${esc(c.directLabel)}</span><strong>contact@komolongevity.com</strong></a></aside><div class="professional-form-panel reveal"><header><div><h3>${esc(c.formTitle)}</h3><p>${esc(c.formLead)}</p></div><span class="professional-form-time">${esc(c.time)}</span></header><form data-professional-contact data-locale="${locale}" novalidate><div class="professional-honeypot" aria-hidden="true"><label>Company URL<input name="companyUrl" tabindex="-1" autocomplete="off"></label></div><input type="hidden" name="source"><input type="hidden" name="utmSource"><input type="hidden" name="utmMedium"><input type="hidden" name="utmCampaign"><section class="professional-form-section"><div class="professional-form-section-title"><span>01</span><strong>${esc(c.sections[0])}</strong></div><div class="professional-field-grid">${field(c.fields.firstName, 'firstName', 'autocomplete="given-name" required')}${field(c.fields.lastName, 'lastName', 'autocomplete="family-name" required')}${field(c.fields.email, 'email', 'type="email" autocomplete="email" required')}${field(c.fields.phone, 'phone', 'type="tel" autocomplete="tel"')}${field(c.fields.role, 'role', 'autocomplete="organization-title"')}${select(c.fields.preferredContact, 'preferredContact', c.contact)}</div></section><section class="professional-form-section"><div class="professional-form-section-title"><span>02</span><strong>${esc(c.sections[1])}</strong></div><div class="professional-field-grid">${field(c.fields.organisation, 'organisation', 'autocomplete="organization" required')}${select(c.fields.organisationType, 'organisationType', c.organisationTypes, true)}${field(c.fields.website, 'website', 'type="url" inputmode="url" placeholder="https://"')}${field(c.fields.city, 'city', 'autocomplete="address-level2"')}${field(c.fields.country, 'country', 'autocomplete="country-name"')}${select(c.fields.sites, 'sites', c.sites)}</div></section><section class="professional-form-section"><div class="professional-form-section-title"><span>03</span><strong>${esc(c.sections[2])}</strong></div><div class="professional-field"><label>${esc(c.interestsTitle)}</label><div class="professional-choice-grid">${interestChoices}</div></div><div class="professional-field-grid" style="margin-top:1rem">${select(c.fields.assessments, 'assessments', c.assessments)}${select(c.fields.timeline, 'timeline', c.timeline)}</div></section><section class="professional-form-section"><div class="professional-form-section-title"><span>04</span><strong>${esc(c.sections[3])}</strong></div><div class="professional-field-grid professional-field-grid--single"><div class="professional-field"><label for="pro-message">${esc(c.fields.message)}</label><textarea id="pro-message" name="message" placeholder="${esc(c.placeholders.message)}" required></textarea></div></div><label class="professional-consent"><input type="checkbox" name="consent" required><span>${esc(c.consent)}</span></label><p class="professional-form-safety">${esc(c.safety)}</p><div class="professional-form-actions"><button class="button" type="submit">${esc(c.submit)}</button><p class="professional-form-status" data-professional-status aria-live="polite">${esc(c.status)}</p></div></section></form><div class="professional-form-success" data-professional-success hidden tabindex="-1"><h3>${esc(c.successTitle)}</h3><p>${esc(c.successText)}</p></div></div></div></div></section>`;
}
...
for (const [locale, c] of Object.entries(copies)) {
  ...
  console.log(`[professional-contact] ${locale} /contact/ upgraded`);
}
