...
const checks=[
  ...
  ['experience progress is first-page third block',js.includes('Votre progression KŌMØ.')&&js.includes('xp_total')&&js.includes('xp_today')&&js.includes('KŌMØ Points')===false],
