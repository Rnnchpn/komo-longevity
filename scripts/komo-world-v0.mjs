...
const checks=[
  ...
  ['multiplayer reliable presence V0.6.2 present',multiplayer.includes("version:'0.6.2-voice-fallback'")&&multiplayer.includes("persistSession:true")&&multiplayer.includes("komo-world-auth-v1")],
