...
const checks=[
  ...
  ['third-person V3.9 present',(runtime.includes('KOMO_PLAYER_AVATAR_V39')||runtime.includes('KOMO_PLAYER_AVATAR_V31')||runtime.includes('KOMO_PLAYER_AVATAR_V24'))&&runtime.includes("cameraMode='third'")],
  ...
  ['Visual polish V3.9+ present',runtime.includes('KOMO_PLAYER_AVATAR_V39')&&runtime.includes('KOMO_HALL_HOST_V31')&&runtime.includes('THREE.CapsuleGeometry')],
  ...
  ['Immersive Hub V3.9 entry present',runtime.includes("version:'3.9.0-visual-refinement'")&&runtime.includes('KOMO_HEALTH_STATION_V33')&&runtime.includes('KOMO_ENTRY_GUIDE_V33')],
  ...
  ['multiplayer reliable presence V0.7.3 present',multiplayer.includes("version:'0.7.3-avatar-refinement'")&&multiplayer.includes("persistSession:true")&&multiplayer.includes("komo-world-auth-v1")],
  ...
  ['premium avatar refinement present',runtime.includes("g.name='KOMO_PLAYER_AVATAR_V39'")&&runtime.includes('const leftShoe=')&&runtime.includes('const chestPin=')&&multiplayer.includes('function presenceAvatar(runtime,record)')&&multiplayer.includes('new THREE.CapsuleGeometry')],
  ['One World continuous campus present',runtime.includes("version:'3.9.0-visual-refinement'")&&runtime.includes('KOMO_ONE_WORLD_LINKS_V37')&&runtime.includes('function inTwinZone')&&runtime.includes("mode='world';\n  world.visible=true;twinRoom.visible=true;rehabRoom.visible=true;arenaRoom.visible=true")],
  ...
  ['results dashboard V3.8 present',runtime.includes('results-dashboard')&&runtime.includes('results-domains')&&runtime.includes('results-timeline')&&runtime.includes('results-signals')&&runtime.includes('domain-result-comparison')],
