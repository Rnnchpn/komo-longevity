...
const checks=[
  ...
  ['Immersive Hub V3.7 entry present',runtime.includes("version:'3.7.0-one-world'")&&runtime.includes('KOMO_HEALTH_STATION_V33')&&runtime.includes('KOMO_ENTRY_GUIDE_V33')],
  ...
  ['multiplayer reliable presence V0.7.2 present',multiplayer.includes("version:'0.7.2-one-world-ui'")&&multiplayer.includes("persistSession:true")&&multiplayer.includes("komo-world-auth-v1")],
  ...
  ['One World continuous campus present',runtime.includes("version:'3.7.0-one-world'")&&runtime.includes('KOMO_ONE_WORLD_LINKS_V37')&&runtime.includes('function inTwinZone')&&runtime.includes("mode='world';\n  world.visible=true;twinRoom.visible=true;rehabRoom.visible=true;arenaRoom.visible=true")],
  ['transient zone label present',runtime.includes('function showWorldZone(label)')&&runtime.includes("locationChip?.classList.add('show')")],
  ['results dashboard V3.7 present',runtime.includes('results-dashboard')&&runtime.includes('results-domains')&&runtime.includes('domain-result-comparison')],
