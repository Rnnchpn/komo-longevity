...
const checks=[
  ...
  ['multiplayer reliable presence V0.4+ present',multiplayer.includes("version:'0.5.3-clock-safe-presence'")&&multiplayer.includes("persistSession:true")&&multiplayer.includes("komo-world-auth-v1")],
