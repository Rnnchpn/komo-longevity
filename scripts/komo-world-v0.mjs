...
const checks=[
  ...
  ['multiplayer reliable presence V0.6.1 present',multiplayer.includes("version:'0.6.1-push-to-talk'")&&multiplayer.includes("persistSession:true")&&multiplayer.includes("komo-world-auth-v1")],
  ...
  ['proximity voice present',multiplayer.includes("getUserMedia")&&multiplayer.includes("RTCPeerConnection")&&multiplayer.includes("VOICE_ENTER_M=11")&&multiplayer.includes("world_voice_signals")],
