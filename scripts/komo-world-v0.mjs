...
const checks=[
  ['V7.3.2 HTML cache bust present',html.includes('world-v1.css?v=7.3.2-arrival-experience')&&html.includes('world-v1.js?v=7.3.2-arrival-experience')&&html.includes('name="komo-world-version" content="7.3.2-arrival-experience"')],
  ...
  ['V7.3.2 inhabited arrival architecture present',runtime.includes("arrivalExperienceV732.name='KOMO_ARRIVAL_EXPERIENCE_V732'")&&runtime.includes('Twin side water gardens')&&runtime.includes('Small water/light markers')],
  ...
  ['Immersive Hub V7.3.2 entry present',runtime.includes("version:'7.3.2-arrival-experience'")&&runtime.includes('KOMO_HEALTH_STATION_V33')&&runtime.includes('KOMO_ENTRY_GUIDE_V33')],
  ...
  ['One World continuous campus present',runtime.includes("version:'7.3.2-arrival-experience'")&&runtime.includes('KOMO_ONE_WORLD_LINKS_V37')&&runtime.includes('function inTwinZone')&&runtime.includes("mode='world';\n  setCameraMode('first');\n  world.visible=true;twinRoom.visible=true;rehabRoom.visible=true;arenaRoom.visible=true")],
