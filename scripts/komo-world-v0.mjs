...
const checks=[
  ...
  ['Immersive Hub V4.3 entry present',runtime.includes("version:'4.3.0-hall-lighting'")&&runtime.includes('KOMO_HEALTH_STATION_V33')&&runtime.includes('KOMO_ENTRY_GUIDE_V33')],
  ...
  ['One World continuous campus present',runtime.includes("version:'4.3.0-hall-lighting'")&&runtime.includes('KOMO_ONE_WORLD_LINKS_V37')&&runtime.includes('function inTwinZone')&&runtime.includes("mode='world';\n  world.visible=true;twinRoom.visible=true;rehabRoom.visible=true;arenaRoom.visible=true")],
