...
const checks=[
  ...
  ['Immersive Hub V6.4 entry present',runtime.includes("version:'6.9.0-cross-device-parity'")&&runtime.includes('KOMO_HEALTH_STATION_V33')&&runtime.includes('KOMO_ENTRY_GUIDE_V33')],
  ...
  ['One World continuous campus present',runtime.includes("version:'6.9.0-cross-device-parity'")&&runtime.includes('KOMO_ONE_WORLD_LINKS_V37')&&runtime.includes('function inTwinZone')&&runtime.includes("mode='world';\n  world.visible=true;twinRoom.visible=true;rehabRoom.visible=true;arenaRoom.visible=true")],
  ...
  ['V6.9 premium avatar framing parity present',runtime.includes("let thirdPersonDistance=5.35")&&runtime.includes("bodyRoot.scale.set(.92,.94,.92)")&&runtime.includes("const desiredFov=50+2.4*runAmount")],
  ...
  ['Resilient guest entry V1.2 present',multiplayer.includes('signInAnonymously')&&multiplayer.includes('const connectGuest=async')&&multiplayer.includes('const startLocalGuest=async')&&multiplayer.includes("version:'1.2.1-entry-resilience'")&&multiplayer.includes("emitSessionReady('guest-local')")],
