...
const checks=[
  ...
  ['multiplayer reliable presence V0.6 present',multiplayer.includes("version:'0.6.0-social-voice'")&&multiplayer.includes("persistSession:true")&&multiplayer.includes("komo-world-auth-v1")],
