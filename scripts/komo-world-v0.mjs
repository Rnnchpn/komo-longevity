...
const checks=[
  ...
  ['fluid run camera V5.2 present',runtime.includes('const runAmount=THREE.MathUtils.clamp(velocity.length()/AUTO_RUN_SPEED')&&runtime.includes('const desiredFov=(lowPower?60:54)')&&runtime.includes('thirdPersonDistance+(lowPower?.10:.34)*runAmount')],
