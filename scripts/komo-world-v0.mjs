...
const checks=[
  ...
  ['Immersive Hub V5.0 entry present',runtime.includes("version:'5.0.0-desktop-visual-revolution'")&&runtime.includes('KOMO_HEALTH_STATION_V33')&&runtime.includes('KOMO_ENTRY_GUIDE_V33')],
  ...
  ['multiplayer reliable presence V0.9.0 present',multiplayer.includes("version:'0.9.0-social-challenges'")&&multiplayer.includes("persistSession:true")&&multiplayer.includes("komo-world-auth-v1")],
