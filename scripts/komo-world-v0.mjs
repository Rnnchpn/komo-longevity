...
const checks=[
  ...
  ['multiplayer auth isolation V1.3 present',multiplayer.includes("version:'1.3.0-human-avatar'")&&multiplayer.includes("persistSession:false")&&multiplayer.includes("autoRefreshToken:false")&&!multiplayer.includes("storageKey:'komo-world-auth-v1'")],
