...
const checks=[
  ...
  ['multiplayer reliable presence V0.7.1 present',multiplayer.includes("version:'0.7.1-desktop-clarity'")&&multiplayer.includes("persistSession:true")&&multiplayer.includes("komo-world-auth-v1")],
