...
const checks=[
  ...
  ['Immersive Hub V6.4 entry present',runtime.includes("version:'7.0.0-human-avatar'")&&runtime.includes('KOMO_HEALTH_STATION_V33')&&runtime.includes('KOMO_ENTRY_GUIDE_V33')],
  ...
  ['multiplayer auth isolation V1.2 present',multiplayer.includes("version:'1.2.1-entry-resilience'")&&multiplayer.includes("persistSession:false")&&multiplayer.includes("autoRefreshToken:false")&&!multiplayer.includes("storageKey:'komo-world-auth-v1'")],
  ...
  ['V6.2 optional avatar entry present',html.includes('id="intro-avatar-open"')&&!html.includes('id="intro-avatar-config"')&&runtime.includes("if(introAvatarOpen)introAvatarOpen.addEventListener")&&runtime.includes("performance:{roughness:.62")&&css.includes('V6.2 Intro — avatar customisation is optional')],
  ...
  ['V7 human avatar rig present',runtime.includes("g.name='KOMO_PLAYER_AVATAR_V70_HUMAN'")&&runtime.includes('const makeShoe=')&&runtime.includes('const makeHand=')&&runtime.includes('const shoulderGeo=')&&multiplayer.includes("g.name='KOMO_REMOTE_V70_'")&&multiplayer.includes('const makeShoe=')&&multiplayer.includes('const makeHand=')],
  ...
  ['V7 adult proportions present',runtime.includes('hips.scale.set(1.12,.58,.78)')&&runtime.includes('leftKnee.position.y=-.535')&&runtime.includes('new THREE.SphereGeometry(.122')&&runtime.includes('new THREE.CapsuleGeometry(.034,.072')&&multiplayer.includes('q.scale.set(1.12,.58,.78)')&&multiplayer.includes('new THREE.SphereGeometry(.122')],
  ['One World continuous campus present',runtime.includes("version:'7.0.0-human-avatar'")&&runtime.includes('KOMO_ONE_WORLD_LINKS_V37')&&runtime.includes('function inTwinZone')&&runtime.includes("mode='world';\n  world.visible=true;twinRoom.visible=true;rehabRoom.visible=true;arenaRoom.visible=true")],
  ...
  ['V7 premium avatar framing present',runtime.includes("let thirdPersonDistance=5.35")&&runtime.includes("g.name='KOMO_PLAYER_AVATAR_V70_HUMAN'")&&runtime.includes("const desiredFov=50+2.4*runAmount")],
  ...
  ['running animation V5.3 present',runtime.includes('av.leftLeg.rotation.x=stride*.69')&&runtime.includes('av.leftKnee.rotation.x=Math.max(0,-stride)*.94')&&runtime.includes('av.torsoGroup.rotation.x=-.018-.058*moveAmount')],
  ...
  ['Resilient guest entry V1.3 present',multiplayer.includes('signInAnonymously')&&multiplayer.includes('const connectGuest=async')&&multiplayer.includes('const startLocalGuest=async')&&multiplayer.includes("version:'1.3.0-human-avatar'")&&multiplayer.includes("emitSessionReady('guest-local')")],
  ...
  ['V7 remote visible-floor grounding present',multiplayer.includes('KOMO_REMOTE_BODY_GROUNDING_V70')&&multiplayer.includes('runtime.getAvatarGroundLift?.(peer.position)')&&multiplayer.includes('av.ring.position.y=remoteSurface+.008')],
