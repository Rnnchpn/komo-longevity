...
const checks=[
  ...
  ['One World continuous campus present',runtime.includes("version:'5.0.1-avatar-grounding'")&&runtime.includes('KOMO_ONE_WORLD_LINKS_V37')&&runtime.includes('function inTwinZone')&&runtime.includes("mode='world';\n  world.visible=true;twinRoom.visible=true;rehabRoom.visible=true;arenaRoom.visible=true")],
