...
const checks=[
  ...
  ['third-person V4.2.1 present',runtime.includes('KOMO_PLAYER_AVATAR_V42_REALISM')&&runtime.includes("cameraMode='third'")&&runtime.includes('const eyeY=player.y+2.03+bob')],
  ...
  ['Immersive Hub V4.4 entry present',runtime.includes("version:'4.4.0-materials-realism'")&&runtime.includes('KOMO_HEALTH_STATION_V33')&&runtime.includes('KOMO_ENTRY_GUIDE_V33')],
  ...
  ['One World continuous campus present',runtime.includes("version:'4.4.0-materials-realism'")&&runtime.includes('KOMO_ONE_WORLD_LINKS_V37')&&runtime.includes('function inTwinZone')&&runtime.includes("mode='world';\n  world.visible=true;twinRoom.visible=true;rehabRoom.visible=true;arenaRoom.visible=true")],
