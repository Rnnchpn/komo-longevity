...
const checks=[
  ...
  ['auto-run gameplay V5.2 present',runtime.includes('const AUTO_RUN_SPEED=lowPower?5.55:6.35')&&runtime.includes('const AUTO_RUN_BOOST=lowPower?6.20:7.15')&&runtime.includes('tryMoveSmooth')],
  ...
  ['Immersive Hub V5.2 entry present',runtime.includes("version:'5.2.0-fluid-rooms'")&&runtime.includes('KOMO_HEALTH_STATION_V33')&&runtime.includes('KOMO_ENTRY_GUIDE_V33')],
  ...
  ['adult running gait V5.2 present',runtime.includes('av.leftKnee.rotation.x=Math.max(0,-stride)*.64')&&runtime.includes('av.torsoGroup.rotation.x=-.016-.030*moveAmount')&&multiplayer.includes('av.leftKnee.rotation.x=Math.max(0,-stride)*.40')],
  ...
  ['One World continuous campus present',runtime.includes("version:'5.2.0-fluid-rooms'")&&runtime.includes('KOMO_ONE_WORLD_LINKS_V37')&&runtime.includes('function inTwinZone')&&runtime.includes("mode='world';\n  world.visible=true;twinRoom.visible=true;rehabRoom.visible=true;arenaRoom.visible=true")],
  ...
  ['permanent auto-run V5.2 present',runtime.includes('const AUTO_RUN_SPEED=lowPower?5.55:6.35')&&runtime.includes('const AUTO_RUN_BOOST=lowPower?6.20:7.15')&&runtime.includes('tryMoveSmooth')&&runtime.includes("BOOST (COURSE AUTO)")],
  ['running animation V5.2 present',runtime.includes('av.leftLeg.rotation.x=stride*.47')&&runtime.includes('av.leftKnee.rotation.x=Math.max(0,-stride)*.64')&&runtime.includes('av.torsoGroup.rotation.x=-.016-.030*moveAmount')],
  ...
  ['room access V5.2 present',runtime.includes('KOMO_ROOM_ACCESS_V52')&&runtime.includes("KOMO_ACCESS_'+id+'_V52")&&runtime.includes("title:'FUNCTIONAL TWIN'")&&runtime.includes("title:'KŌMØ FITNESS'")&&runtime.includes("title:'ARENA'")],
