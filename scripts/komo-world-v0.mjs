...
const checks=[
  ...
  ['multiplayer reliable presence V0.7 present',multiplayer.includes("version:'0.7.0-desktop-hud'")&&multiplayer.includes("persistSession:true")&&multiplayer.includes("komo-world-auth-v1")],
