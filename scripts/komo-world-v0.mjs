...
const checks=[
  ...
  ['Immersive Hub V6.1 entry present',runtime.includes("version:'6.1.0-grand-flagship-ui'")&&runtime.includes('KOMO_HEALTH_STATION_V33')&&runtime.includes('KOMO_ENTRY_GUIDE_V33')],
  ...
  ['V6.1 entrance avatar configurator present',html.includes('id="intro-avatar-config"')&&html.includes('data-intro-avatar-key="look"')&&runtime.includes('function syncIntroAvatarControls')&&runtime.includes("performance:{roughness:.62")&&css.includes('V6.1 Entrance Character Configurator')],
  ...
  ['One World continuous campus present',runtime.includes("version:'6.1.0-grand-flagship-ui'")&&runtime.includes('KOMO_ONE_WORLD_LINKS_V37')&&runtime.includes('function inTwinZone')&&runtime.includes("mode='world';\n  world.visible=true;twinRoom.visible=true;rehabRoom.visible=true;arenaRoom.visible=true")],
