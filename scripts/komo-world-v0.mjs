...
const checks=[
  ...
  ['third-person V4.2 present',runtime.includes('KOMO_PLAYER_AVATAR_V42_REALISM')&&runtime.includes("cameraMode='third'")&&runtime.includes('const eyeY=player.y+1.96+bob')],
  ...
  ['Immersive Hub V4.2 entry present',runtime.includes("version:'4.2.0-avatar-realism'")&&runtime.includes('KOMO_HEALTH_STATION_V33')&&runtime.includes('KOMO_ENTRY_GUIDE_V33')],
  ...
  ['multiplayer reliable presence V0.8.1 present',multiplayer.includes("version:'0.8.1-v42-avatar-realism'")&&multiplayer.includes("persistSession:true")&&multiplayer.includes("komo-world-auth-v1")],
  ...
  ['adult gait V4.2 present',runtime.includes('av.leftKnee.rotation.x=Math.max(0,-stride)*.46')&&runtime.includes('av.torsoGroup.rotation.x=-.008*moveAmount')&&multiplayer.includes('av.leftKnee.rotation.x=Math.max(0,-stride)*.43')],
  ['One World continuous campus present',runtime.includes("version:'4.2.0-avatar-realism'")&&runtime.includes('KOMO_ONE_WORLD_LINKS_V37')&&runtime.includes('function inTwinZone')&&runtime.includes("mode='world';\n  world.visible=true;twinRoom.visible=true;rehabRoom.visible=true;arenaRoom.visible=true")],
