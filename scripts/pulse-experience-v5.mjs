...
html=html.replace('<a href="https://komolongevity.com/fr/contact/" target="_blank" rel="noopener noreferrer">Aide & contact ↗</a>','<a href="https://komolongevity.com/fr/" target="_blank" rel="noopener noreferrer">Site KŌMØ ↗</a><a href="https://komolongevity.com/fr/cgv/" target="_blank" rel="noopener noreferrer">Conditions générales ↗</a><a href="https://komolongevity.com/fr/contact/" target="_blank" rel="noopener noreferrer">Aide & contact ↗</a>');
...
if(!html.includes('./account-hub-v2.css'))html=html.replace('</head>','  <link rel="stylesheet" href="./account-hub-v2.css" />\n</head>');
if(!html.includes('./product-polish-v8.css'))html=html.replace('</head>','  <link rel="stylesheet" href="./product-polish-v8.css" />\n</head>');
...
if(!html.includes('./account-hub-v2.js'))html=html.replace('</body>','  <script type="module" src="./account-hub-v2.js"></script>\n</body>');
await writeFile('pulse-app/index.html',html);
console.log('[pulse-experience-v5] compact surfaces, account billing/legal hub, stable scores, center workspace and shared inbox wired');
