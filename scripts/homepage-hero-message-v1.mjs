...
const newHero = '<h1>Votre mobilité, mesurée.<br>Votre longévité, <em>en mouvement.</em></h1>';
...
if (!html.includes(oldHero) && !html.includes(priorHeroA) && !html.includes(priorHeroB) && !html.includes(newHero)) {
  throw new Error('[homepage-hero-message-v1] hero title target not found');
}

html = html.replace(oldHero, newHero).replace(priorHeroA, newHero).replace(priorHeroB, newHero);
