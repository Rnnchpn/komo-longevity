...
const RELEASE='20260828-myocare-real-contract-2';
...
console.log('[pulse-v12] canonical MyoCare stack: real MyoLab export adapter v0.2, no legacy parser/fallback, automatic Motion v0.5.1 recalculation');