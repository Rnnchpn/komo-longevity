...
html=html.replace(/(<script src="\.\/runtime\.js[^>]*><\/script>)/,'  <script src="./center-patient-absolute-link-v7.js?v=20260828-absolute-dossier-7"></script>\n  $1');
...
console.log('[pulse-v12] standalone app copied to /pulse-v12/ with full-row native patient dossier navigation, standalone dossier page, MyoCare import and two-tab center workspace');
