...
const RELEASE='20260828-club-native-v1';
...
console.log('[pulse-v12] Native Club = canonical patient route, equal dock item, My KOMO entry, legacy floating Club controls hidden');
