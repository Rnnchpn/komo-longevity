...
const RELEASE='20260828-auth-canonical-1';
...
console.log('[pulse-v12] canonical auth + center stack: one login owner, patient links, dossier, MyoCare import and patient polish');