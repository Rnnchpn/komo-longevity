...
console.log('[pulse-v12] standalone app copied to /pulse-v12/ with patient onboarding, direct dossier MyoCare import, stable centered patient dossier and two-tab center workspace');
