...
const RELEASE='20260828-navigation-core-v1';
...
console.log('[pulse-v12] Navigation core v1 = single patient router, dock v5, legacy Motion navigation removed, Club preserved');
