...
const RELEASE='20260829-report-delivery-v1';
...
const remove=[
  ...
  /\s*<script src="\.\/patient-navigation-core-v1\.js(?:\?[^\"]*)?"><\/script>/g,
  ...
  /\s*<script src="\.\/motion-route-guard-v4\.js(?:\?[^\"]*)?"><\/script>/g,
  ...
  /\s*<script type="module" src="\.\/report-bootstrap-v1\.js(?:\?[^\"]*)?"><\/script>/g,
  ...
  /\s*<script src="\.\/pulse-bottom-nav-v5\.js(?:\?[^\"]*)?"><\/script>/g,
  ...
  /\s*<script src="\.\/my-komo-club-entry-v1\.js(?:\?[^\"]*)?"><\/script>/g,
  ...
  /\s*<script type="module" src="\.\/club-hub-v1\.js(?:\?[^\"]*)?"><\/script>/g,
  /\s*<script type="module" src="\.\/club-connections-v1\.js(?:\?[^\"]*)?"><\/script>/g
];
...
console.log('[pulse-v12] Native Club = canonical patient route, equal dock item, My KOMO entry, legacy floating Club controls hidden · official Mobility Report wired');