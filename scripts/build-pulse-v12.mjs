...
html=html.replace(/(<script src="\.\/runtime\.js[^>]*><\/script>)/,'  <script src="./center-patient-click-gate-v5.js?v=20260828-click-gate-5"></script>\n  $1');
...
console.log('[pulse-v12] standalone app copied to /pulse-v12/ with earliest click gate, deterministic centered patient dossier, direct MyoCare import and two-tab center workspace');
