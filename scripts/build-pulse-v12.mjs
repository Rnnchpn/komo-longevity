...
const RELEASE='20260828-patient-home-micro-motion-v1-2';
...
console.log('[pulse-v12] patient home v3 = light KŌMØ data wall + premium micro motion; v2 fallback retained but visually suppressed');
