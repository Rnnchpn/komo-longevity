...
const RELEASE='20260828-motion-tests-1';
...
dossier=dossier.replace(/\s*<script src="\.\/navigation-scroll-top\.js(?:\?[^\"]*)?"><\/script>/g,'');
...
console.log('[pulse-v12] canonical MyoCare + Motion + patient test entry + calculated results + global scroll reset wired');
