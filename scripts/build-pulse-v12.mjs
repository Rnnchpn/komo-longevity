...
const RELEASE='20260828-myocare-real-contract-1';
...
console.log('[pulse-v12] canonical auth + center + MyoCare v0.2 stack: real MyoLab export adapter, patient dossier and score recalculation');