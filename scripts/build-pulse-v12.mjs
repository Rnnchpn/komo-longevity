...
console.log('[pulse-v12] standalone app copied to /pulse-v12/ with deterministic centered patient dossier, direct MyoCare import and two-tab center workspace');
