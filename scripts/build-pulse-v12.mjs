...
const RELEASE='20260828-pulse-home-hero-polish-v2';
...
console.log('[pulse-v12] patient home v3 = larger Pulse brand, no top Motion shortcut, stronger KŌMØ Age + animated hero score');
