...
// Home V6 owns one daily Motion Today surface. KEY remains a dedicated route and must not be reparented into Home.
html=html
...
const checks=[
  ...
  ['Home V6 owns Motion Today',home.includes("const VERSION='6.0.0'")&&home.includes('data-khome-v6')&&home.includes('MOTION TODAY')],
