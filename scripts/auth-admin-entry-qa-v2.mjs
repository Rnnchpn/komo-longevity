...
const [html,app,auth,adminShortcut,adaptive]=await Promise.all([
...
const polishedAdminLink=(adminShortcut.includes("pop.querySelector('.kam-body')")||adminShortcut.includes("querySelector('#accountPopover')")||adminShortcut.includes("querySelector(\"#accountPopover\")"))&&(adminShortcut.includes("classList.add('kam-link','kam-admin-account')")||adminShortcut.includes("className='kam-link kam-admin-account'")||adminShortcut.includes('className="kam-link kam-admin-account"'));
const sharedAdminRuntime=adminShortcut.includes('window.KomoRuntime?.client')&&(adminShortcut.includes("runtimeRole==='admin'")||adminShortcut.includes("rr==='admin'")||adminShortcut.includes("role==='admin'"));
const checks=[
  ...
  ['admin account shortcut survives polished menu',polishedAdminLink],
  ['admin shortcut uses shared runtime role/client',sharedAdminRuntime],
