...
const [html,patient,pro,authGateway,inject,mig]=await Promise.all([
 ...
 readFile(join(root,'pulse-app','auth-gateway-v2.js'),'utf8'),
...
const checks=[
 ...
 ['professional composed form captures complete common identity',common.every(k=>proComposed.includes(`name="${k}"`)||proComposed.includes(`${k}:`))],
