...
const release='20260829-patient-clean-room-v3';
...
// IMPORTANT: this desktop/tablet clean-room layer must never rewrite the
// canonical phone runtime. Phone Home is owned by mobile-canonical-v1.
...
console.log('[pulse-patient-clean-room] desktop/tablet clean Home preserved; canonical phone Home left untouched');