...
console.log(`[pulse-freeze-final-manifest-v1] ${Object.keys(manifest.surfaces).length} final surfaces · Motion V4 frozen · Therapy removed after runtime freeze · account extensions declared`);
