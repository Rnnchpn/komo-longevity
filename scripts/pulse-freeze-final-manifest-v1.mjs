...
const manifest={
  version:'2026-09-01-motion-v4-admin-pro-single-owner-v3',
  principles:[
...
console.log(`[pulse-freeze-final-manifest-v1] ${Object.keys(manifest.surfaces).length} final surfaces · Motion V4 frozen · Admin first paint stable · single professional surface`);
