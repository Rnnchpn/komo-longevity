...
const resultsHasScopedMountGuard=results.includes("!root.querySelector('[data-kresults-v1]')")||results.includes("!document.querySelector('[data-kresults-v1]')");
const checks=[
  ...
  ['Results journey prevents duplicate prepend',results.includes("key===lastKey&&root.querySelector('[data-kresults-v1]')")&&resultsHasScopedMountGuard],
