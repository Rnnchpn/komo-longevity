...
const canonicalAdminNav=shortcut.includes("window.KomoPatientNavigation?.go?.('admin')")||shortcut.includes("location.hash='admin'");
const checks=[
 ...
 ['shortcut routes to admin through canonical navigation',canonicalAdminNav&&!shortcut.includes('data-kcp-admin-tab')],
