...
const checks=[
 ...
 ['desktop Home keeps KEY separate from Motion Score',home.includes('restent séparées du calcul du Motion Score')],
 ['desktop Home restores current data-wall hierarchy',home.includes('khc-actions')&&home.includes('Votre Motion Score.')&&home.includes('KŌMØ LOCOMOTOR AGE')&&home.includes('MOVE. RECOVER.')&&home.includes('Ouvrir My Key')],
