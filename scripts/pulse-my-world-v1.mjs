...
const RELEASE='20260905-my-world-v12-s01';
...
manifest.version='2026-09-05-my-world-v12-s01';
manifest.surfaces.mykomo={
  owner:'my-world-v1.js',
  controllers:['my-world-pulse-bridge-v1.js'],
  extensions:['my-world-design-s01-hero.js']
};
...
const design=await read('my-world-design-s01-hero.js');
const forbiddenDesignSelectors=['.kmw-stat','.kmw-action','.kmw-card','.kmw-context'];
const checks=[
  ...
  ['hero design stratum injected',finalHtml.includes(`my-world-design-s01-hero.js?v=${RELEASE}`)],
  ['hero design is isolated',forbiddenDesignSelectors.every(selector=>!design.includes(selector))],
  ['hero design has architectural portal',design.includes('.kmw-hero .kmw-portal:before')&&design.includes('PERSONAL ARRIVAL')],
  ...
  ['hero design is declared extension',(manifest.surfaces.mykomo?.extensions||[]).includes('my-world-design-s01-hero.js')],
...
console.log(`[pulse-my-world-v1] PASS · ${checks.length}/${checks.length} · My World identity bridge + design stratum 01 ready`);
