...
begin
  ...
  return jsonb_build_object(
    ...
    'algorithm_version', 'motion-today-v1.0'
  );
end;
$$;

revoke all on function public.komo_motion_today_v1() from public;
revoke all on function public.komo_motion_today_v1() from anon;
grant execute on function public.komo_motion_today_v1() to authenticated;
