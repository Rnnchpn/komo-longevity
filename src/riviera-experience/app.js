(() => {
  ...
  form.addEventListener("submit", async (event) => {
    ...
    setStatus("Sending your invitation request…");

    try {
      const response = await fetch("https://komolongevity.com/api/riviera-invitation", {
        method: "POST",
      ...
      if (!response.ok || result.status !== "request_received") {
