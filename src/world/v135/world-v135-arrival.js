...
@media(max-width:800px){
  ...
  #interaction{left:50%!important;right:auto!important;width:min(245px,calc(100vw - 20px))!important;bottom:calc(var(--komo-world-safe-bottom) + 156px)!important;max-width:none!important;min-height:58px!important;transform:translate(-50%,10px)!important;padding:9px 10px!important;border-radius:17px!important}#interaction.show{transform:translateX(-50%)!important}#interaction-key{display:none!important}#interaction-title{font-size:12px!important}#interaction-copy{font-size:8px!important;line-height:1.35!important}
